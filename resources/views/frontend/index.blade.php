...
<head>
    ...
    <link rel="stylesheet"  href="css/prjct3.css">
    ...
    <section class="header">
        ...
        <div class="text-box">
            ...
            <p>Making website is now one of the easiest thing in the world. you 
                just need to learn <br>HTML,CSS,Javascript and you are good to go.
...
<section class="campus">
    ...
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Making website 
        is now one of the easiest thing in the world.</p>
...
<section class="facilities">
    ...
    <div class="row">
        <div class="facilities-col">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Making
                 website is now one of the easiest thing in the world.</p>
        ...
        <div class="testimonial-col">
            ...
            <div>
                <p>
                    ...
                    website is now one of the easiest thing in the world. you just 
                    need to learn HTML,CSS,Javascript and you are good to go.
                </p>
                <h3>Christein Berkely</h3>
...
<h4>About Us</h4>
<P>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Making
    website is now one of the easiest thing in the world. <br>you just 
    need to learn HTML,CSS,Javascript and you are good to go.
</P>
<div class="icons">
...
<p>Made with <i class="fa fa-heart-o" style="color:red;"></i> by pradeep_sudda</p>
